function [e_norm_1, e_norm_2, e_norm_inf] = mms_vsfm_compute_error(...
    X, nxs, problem_dim, comp_soln, manu_soln)
% [e_norm_1, e_norm_2, e_norm_inf] = MMS_VSFM_COMPUTE_ERROR(X, nxs, problem_dim, comp_soln, manu_soln)
% Computes L1, L2, and L-infinity error norms for the MMS VSFM problem.
%
